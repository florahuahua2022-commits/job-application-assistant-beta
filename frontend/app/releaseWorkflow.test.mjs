...
test("only a job description and resume gate generation", () => {
  assert.equal(canGenerate(false, true), false);
  assert.equal(canGenerate(true, false), false);
  assert.equal(canGenerate(true, true), true);
});
