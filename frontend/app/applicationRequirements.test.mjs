...
import { documentChoiceLabel, formatSubmissionLimit, requiredGeneratedDocumentTypes, requirementsHasUnknown, unresolvedRequirementLabels } from "./applicationRequirements.ts";
