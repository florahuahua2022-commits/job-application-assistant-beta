    ...
    def setUp(self):
        ...
        with Session(self.engine) as session:
            ...
            resume = Resume(source_text="Alex Morgan", ckb_json=json.dumps([
                {"schema_version": "2.1", "evidence_id": "E1", "source_text": "Supported procurement administration."},
                {"schema_version": "2.1", "evidence_id": "E2", "source_text": "Prepared monthly reports."},
            ]))
